    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 700, y: groundY - 103, health : 50, image : , scale : , X : , Y : },
          { type: "reward", x: 1100, y: groundY - 103, health : 15, image : , scale : , X : , Y : },
          { type: "reward", x: 1500, y: groundY - 103, health : 5, image : , scale : , X : , Y : },

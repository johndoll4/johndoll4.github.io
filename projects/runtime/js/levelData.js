    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 700, y: groundY - 103, health : 50, image : "img/luhmedkit", scale : 0.25, X : 25, Y : 25},
          { type: "reward", x: 1100, y: groundY - 103, health : 15, image : "img/luhshield", scale : 0.35, X : 25, Y : 25},
          { type: "reward", x: 1500, y: groundY - 103, health : 5, image : "img/bandages", scale : 0.35, X : 25, Y : 25},

    ...
    var levelData = [
      {
        ...
        speed: -3,
        gameItems: [
          { type: "sawblade", x: 400, y: groundY - 20, hitsize : 25, damage : 10, image: "img/tumbleweed.png", rotate : 10, offsetX : -25, offsetY : -25, scale : 1},
          { type: "sawblade", x: 900, y: groundY - 101, hitsize : 25, damage : 10, image: "img/battlebus.png", rotate : 0, offsetX : -75, offsetY : -60, scale : 0.5},
          { type: "sawblade", x: 1234, y: groundY - 10, hitsize : 25, damage : 10, image: "img/tumbleweed.png", rotate : 10, offsetX : -25, offsetY : -25, scale : 1},
